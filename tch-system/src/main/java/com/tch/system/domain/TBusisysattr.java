...
/**
 * 业务附件对象 t_busisysattr
 * 
 * @author wythe
 * @date 2024-03-18
 */
public class TBusisysattr extends BaseEntity
{
    ...
    /** 备用二进制字段1 */
    @Excel(name = "备用二进制字段1")
    private String tblob1;

    /** 备用二进制字段2 */
    @Excel(name = "备用二进制字段2")
    private String tblob2;
    ...
    public void setTblob1(String tblob1) 
    {
        this.tblob1 = tblob1;
    }

    public String getTblob1() 
    {
        return tblob1;
    }
    public void setTblob2(String tblob2) 
    {
        this.tblob2 = tblob2;
    }

    public String getTblob2() 
    {
        return tblob2;
    }
