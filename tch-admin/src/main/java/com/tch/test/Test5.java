...
//                basic.setTaskType(Constants.QT);
//            } else {
//                switch (itemType) {
//                    case "XK":
//                        basic.setTaskType(Constants.XK);
//                        break;
//                    case "GG":
//                        basic.setTaskType(Constants.GG);
//                        break;
//                    case "CJ":
//                        basic.setTaskType(Constants.CJ);
//                        break;
//                    case "QR":
//                        basic.setTaskType(Constants.QR);
//                        break;
//                    case "JL":
//                        basic.setTaskType(Constants.JL);
//                        break;
//                    case "AP":
//                        basic.setTaskType(Constants.AP);
//                        break;
//                    case "NS":
//                        basic.setTaskType(Constants.NS);
//                        break;
//                    default:
//                        basic.setTaskType(Constants.QT);
//                        break;
